...
CMenuScreenCustom aScreens[] = {
	...
	{ "FEM_MM", MENUPAGE_DISABLED, nil, nil,
		  ...
		  MENUACTION_MULTIPLAYER_HOST,	"MP_HOST",	{nil, SAVESLOT_NONE,	MENUPAGE_START_MENU}, 0, 0, MENUALIGN_CENTER,
#endif
		  MENUACTION_MULTIPLAYER_JOIN,	"MP_JOIN",	{nil, SAVESLOT_NONE,	MENUPAGE_START_MENU}, 0, 0, MENUALIGN_CENTER,
